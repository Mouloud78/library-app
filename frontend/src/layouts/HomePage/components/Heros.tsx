        ...
        <div className="row g-0">
          <div className="col-4 col-md-4 container d-flex justify-center align-items-center">
            <div className="ml-2">
              ...
              <p className="lead">
                Try to check in daily as our collecton is always changing! We
                work nonstop to provide the most accurate book selection
                possible for our Luv 2 read students! We are diligent and our
                book selection our books are always going to be our top priority
              </p>
            </div>
          </div>
          <div className="col-sm-6 col-md-6">
